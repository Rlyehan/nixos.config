    ...
    extraConfig =
      ...
      concatStrings [
        ''
          ...
          exec-once = sleep 2 && uwsm app -- swww img /home/${username}/Pictures/Wallpapers/cool.jpg
          exec-once = [workspace 1 silent] uwsm app -- slack
          exec-once = [workspace 2 silent] uwsm app -- brave
          exec-once = [workspace 4 silent] uwsm app -- ghostty
